...
const RightPanel = ({ pokemon, pokemonIndex, changePokemonIndex }: RightPanelProps) => {
    if (!pokemon) {
        return <div></div>;
    }
    ...
    return (
        <Container>
            <StatsAndTypes stats={stats} types={types} weight={weight} height={height} />
            <Evolutions
            ...
            />
            <Moves moves={moves} />
            <Controls pokemonIndex={pokemonIndex} changePokemonIndex={changePokemonIndex} />
        </Container>
    );
};
