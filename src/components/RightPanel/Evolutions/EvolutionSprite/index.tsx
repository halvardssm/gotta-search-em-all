...
const EvolutionSprite = ({ image, stage, name = 'No Data', changePokemonIndex }: EvolutionSpriteProps) => {
    ...
    return (
        <Container>
            ...
            {image && <img className="sprite-small" src={image} alt={name} onClick={handleImageClick} />}
            {!image && <PokeBall />}
